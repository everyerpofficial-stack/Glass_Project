        ...
        <div id="order-booking-form" className="p-3 pb-24 sm:p-4 md:pb-4 w-full">
          <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_320px] gap-4 w-full">
            ...
            <div className="space-y-4 min-w-0">
              ...
              {/* 7. Process & Extra Rates Panel */}
              <Section title="Process & Extra Rates (Manual Rates)">
                <div className="grid grid-cols-2 sm:grid-cols-6 gap-3">
                  <div>
                    <FieldLabel>Hole Rate (₹/pc)</FieldLabel>
                    <Input
                      type="number"
                      min="0"
                      className="h-8 text-xs font-mono"
                      ...
                      onChange={(e) => {
                        ...
                        setInv((prev: any) => ({
                          ...prev,
                          ch: { ...(prev.ch || {}), holeRate: val },
                        }));
                      }}
                    />
                  </div>
                  <div>
                    <FieldLabel>Cutout Rate (₹/pc)</FieldLabel>
                    <Input
                      type="number"
                      min="0"
                      className="h-8 text-xs font-mono"
                      ...
                      onChange={(e) => {
                        ...
                        setInv((prev: any) => ({
                          ...prev,
                          ch: { ...(prev.ch || {}), cutoutRate: val },
                        }));
                      }}
                    />
                  </div>
                  <div>
                    <FieldLabel>Big Hole Rate (₹/pc)</FieldLabel>
                    <Input
                      type="number"
                      min="0"
                      className="h-8 text-xs font-mono"
                      ...
                      onChange={(e) => {
                        ...
                        setInv((prev: any) => ({
                          ...prev,
                          ch: { ...(prev.ch || {}), bigHoleRate: val },
                        }));
                      }}
                    />
                  </div>
                  <div>
                    <FieldLabel>Big Cutout Rate (₹/pc)</FieldLabel>
                    <Input
                      type="number"
                      min="0"
                      className="h-8 text-xs font-mono"
                      ...
                      onChange={(e) => {
                        ...
                        setInv((prev: any) => ({
                          ...prev,
                          ch: { ...(prev.ch || {}), bigCutoutRate: val },
                        }));
                      }}
                    />
                  </div>
                  <div>
                    <FieldLabel>CSK Rate (₹/pc)</FieldLabel>
                    <Input
                      type="number"
                      min="0"
                      className="h-8 text-xs font-mono"
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        setInv((prev: any) => ({
                          ...prev,
                          insurancePct: val,
                          ch: { ...(prev.ch || {}), insurancePercent: val },
                        }));
                      }}
                    />
                  </div>
              ...
              <div className="bg-card border border-border rounded-lg overflow-hidden xl:sticky xl:top-16 shadow-sm">
                ...
                <div className="p-3 sm:p-4 text-xs space-y-2 font-sans">
                  ...
                  {Boolean(totals.holeCharge || totals.holes) && (
                    <div className="flex justify-between items-center py-1 border-b border-border/30 last:border-0 gap-1">
