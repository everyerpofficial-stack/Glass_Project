...
export const DEFAULT_TERMS = [
  "Rates are quoted on the basis of standard available sheet sizes.",
  "For odd shapes 10% extra for cutting and 20% extra for grinding will be charged.",
  "This proforma invoice is valid only for the sizes given. Any change needs a fresh proforma invoice.",
  "Delivery period is 10 days after receipt of the confirmed proforma invoice.",
  "Order is processed on receipt of this proforma invoice duly sealed and signed, subject to commercial clearance and availability of raw material.",
  "Once confirmed, the order cannot be cancelled or returned.",
  "The buyer is responsible for the correctness of the delivery address stated in this proforma invoice.",
  "Unloading is to be arranged by the buyer.",
  "Breakage up to 2% is to the buyer's account. Above 2% is subject to insurance coverage.",
  "For annealed glass, transit breakage is entirely at the buyer's risk.",
  "Any claim or rejection must be raised within 7 days of delivery.",
  "Payment: 100% advance.  Validity: 30 days from the date of this proforma invoice.",
  "Errors and omissions excepted. Interest at 24% applies on payments not made within the due date.",
];
